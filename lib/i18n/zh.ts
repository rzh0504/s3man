export default {
  ...
  'settings.transferHistoryDays': '传输记录保留天数',
  'settings.transferConcurrency': '并发传输数量',
  'settings.transferConcurrencyCount': '{count}',
  ...
  'bucket.empty': '无文件',
  'bucket.emptyDesc': '',
  'bucket.emptyFiles': '无文件',
  'bucket.emptySearch': '无匹配文件',
  'bucket.emptyImages': '无图片文件',
  'bucket.emptyMedia': '无媒体文件',
  'bucket.emptyDocs': '无文档文件',
  'bucket.emptyOther': '无其他文件',
  ...
  'bucket.filterDocs': '文档',
  'bucket.filterOther': '其他',
  'bucket.sortName': '名称',
  'bucket.sortDate': '日期',
  'bucket.sortSize': '大小',
  'bucket.rename': '重命名',
  ...
  'bucket.imageCopied': '图片已复制',
  'bucket.copyFileUnsupported': '暂时不支持复制此类文件',
  'bucket.pathCopied': '路径已复制',
  'bucket.pathsCopied': '路径已复制',
