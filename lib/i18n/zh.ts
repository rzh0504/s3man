export default {
  ...
  'settings.downloadDirectoryOtherDesc':
    '自定义目录目前仅支持 Android，其他平台会保存到应用内部存储。',
  'settings.chooseDownloadDirectory': '选择文件夹',
  'settings.resetDownloadDirectory': '使用默认目录',
  'settings.appUpdates': '应用更新',
  'settings.appUpdatesDesc': '从 GitHub Release 检查、下载并安装新版 APK。',
  'settings.currentVersion': '当前版本',
  'settings.latestVersion': '最新版本',
  'settings.updatePublishedAt': '发布时间',
  'settings.updatePackageSize': '安装包大小',
  'settings.updateNotes': '更新说明',
  'settings.checkUpdates': '检查更新',
  'settings.checkingUpdates': '检查中...',
  'settings.updateAvailable': '发现新版本',
  'settings.noUpdateAvailable': '当前已是最新版',
  'settings.updateDownloading': '下载中...',
  'settings.updateDownloadingProgress': '下载中 {progress}%',
  'settings.downloadUpdate': '下载更新',
  'settings.updateReadyToInstall': '新版本已下载完成，可以开始安装。',
  'settings.installUpdate': '立即安装',
  'settings.ignoreUpdate': '忽略此版本',
  'settings.updateLastError': '更新失败',
  'settings.updateCheckFailed': '检查更新失败',
  'settings.updateDownloadFailed': '下载更新失败',
  'settings.updateInstallFailed': '安装更新失败',
  'settings.updatePermissionDenied': '未授予“安装未知来源应用”权限，请允许后再试。',
  'settings.updatePromptTitle': '发现新版本',
  'settings.updatePromptLater': '稍后',
  'settings.updatePromptDownload': '下载',
  'settings.updatePromptIgnore': '忽略',
  ...
  'form.pathStyleHelp':
    '使用路径风格 URL（endpoint/bucket）。如果服务商要求虚拟主机风格（bucket.endpoint）请关闭。',
